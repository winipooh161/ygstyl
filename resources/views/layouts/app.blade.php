...
<head>
    ...
    {{-- SEO meta-теги --}}
    <meta name="description" content="{{ $meta_description ?? 'Ремонт квартир и домов «под ключ» в Ростовской области' }}">
    ...
    <meta property="og:description" content="{{ $og_description ?? $meta_description ?? 'Ремонт квартир и домов «под ключ» в Ростовской области' }}">
    ...
    <meta name="twitter:description" content="{{ $twitter_description ?? $meta_description ?? 'Ремонт квартир и домов «под ключ» в Ростовской области' }}">
