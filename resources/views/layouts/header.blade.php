    ...
    <div class="container">
        <div class="header__body">
            ...
            <div class="header__number">
                <div class="burger">
                    ...
                    <div class="links">
                        <ul>
                            ...
                            <li class="nav-item"><a href="{{ route('video-reels') }}" class="nav-link smoth-animation">Видео рилсы </a></li>
                ...
                <a class="header__number_a" href="tel:{{ \App\Models\SiteLink::where('key', 'phone')->first()->value }} ">{{ \App\Models\SiteLink::where('key', 'phone')->first()->value }} </a>
                <a href="mailto:{{ \App\Models\SiteLink::where('key', 'email')->first()->value }} ">{{ \App\Models\SiteLink::where('key', 'email')->first()->value }} </a>
            </div>
        </div>
        <ul>
